...
public class DeviceScanActivity extends ListActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.main_heart, menu);
        if (!mScanning) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_skip:
                ...
                intent.putExtra(DeviceControlActivity.EXTRAS_DEVICE_NAME, "null");
                intent.putExtra(DeviceControlActivity.EXTRAS_DEVICE_ADDRESS, "null");
                if (mScanning) {
